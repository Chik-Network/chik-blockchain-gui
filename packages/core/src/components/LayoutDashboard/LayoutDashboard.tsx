import { useGetLoggedInFingerprintQuery, useGetKeyQuery, useFingerprintSettings } from '@chik-network/api-react';
import { Exit as ExitIcon } from '@chik-network/icons';
