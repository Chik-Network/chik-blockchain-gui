...
//   // await page.getByRole('option', { name: 'Chik Holiday 2021 Token (CH21)' }).click();
...
//   await page.locator('text=Amount *TXCK >> input[type="text"]').fill('0.05');
...
//   await page
//     .locator('text=Create an NFT OfferBuy an NFTSell an NFTYou will offerAmount *TXCK50,000,000,000 >> button')
//     .first()
//     .click();
...
//   await page.locator('text=You will offerAsset Type *​Amount *TXCK >> input[type="text"]').fill('0.00000000005');

//   // And I complete Amount under heading In exchange for
//   await page.locator('text=In exchange forAsset Type *​Amount *TXCK >> input[type="text"]').fill('0.00000000005');
