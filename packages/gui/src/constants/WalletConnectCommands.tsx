...
const walletConnectCommands: WalletConnectCommand[] = [
  ...
  },
  {
    ...
    params: [
      ...
      {
        name: WalletConnectCommandParamName.XCK_COINS,
        label: <Trans>XCK Coins</Trans>,
        type: 'object',
        isOptional: true,
      },
      {
        name: WalletConnectCommandParamName.XCK_CHANGE_TARGET,
        label: <Trans>XCK Change Target</Trans>,
        type: 'string',
        isOptional: true,
      },
      {
