...
contextBridge.exposeInMainWorld(API.CHIK_LOGS, {
  getContent: () => invokeWithCustomErrors(ChikLogsAPI.GET_CONTENT),
  getInfo: () => invokeWithCustomErrors(ChikLogsAPI.GET_INFO),
  setPath: () => invokeWithCustomErrors(ChikLogsAPI.SET_PATH),
});
