...
export type ParamSchema = {
  ...
  humanize?: 'mojo-to-xck' | 'mojo-to-cat' | 'puzzle-decorator';
};
...
function getOffer(params: Record<string, unknown>, fileContents: boolean) {
  return sendCommand('get_offer', 'chik_wallet', {
...
export const Commands: Record<string, CommandSchema> = {
  ...
  'chik_app.request_permissions': {
    ...
    dapp: [
      {
        command: 'chik_requestPermissions',
        title: () => i18n._(/* i18n */ { id: 'Request Permissions' }),
  ...
  'chik_wallet.nft_transfer_nft': {
    ...
    params: [
      ...
      { name: 'fee', label: () => i18n._(/* i18n */ { id: 'Fee' }), type: 'bigint', humanize: 'mojo-to-xck' },
    ],
    dapp: [
      {
        command: 'chik_transferNFT',
  ...
  'chik_wallet.create_offer_for_ids': {
    ...
    dapp: [
      {
        command: 'chik_createOfferForIds',
  ...
  'chik_wallet.sign_message_by_address': {
    ...
    dapp: [
      {
        command: 'chik_signMessageByAddress',
  ...
  'chik_wallet.nft_set_nft_did': {
    ...
    dapp: [
      {
        command: 'chik_setNFTDID',
        title: () => i18n._(/* i18n */ { id: 'Set NFT DID' }),
      },
    ],
  },

  // TODO verify param names in chik-blockchain
  ...
  'chik_wallet.create_new_wallet': {
    ...
    dapp: [
      ...
      {
        command: 'chik_createNewDIDWallet',
        ...
        confirmLabel: () => i18n._(/* i18n */ { id: 'Create' }),
        params: [
          { name: 'amount', label: () => i18n._(/* i18n */ { id: 'Amount' }), type: 'bigint', humanize: 'mojo-to-xck' },
          { name: 'fee', label: () => i18n._(/* i18n */ { id: 'Fee' }), type: 'bigint', humanize: 'mojo-to-xck' },
      ...
      {
        command: 'chik_createNewRemoteWallet',
  ...
  'chik_harvester.add_plot_directory': {
  ...
  'chik_harvester.remove_plot_directory': {
  ...
  'chik_full_node.open_connection': {
  ...
  'chik_full_node.close_connection': {
  ...
  'chik_wallet.spend_clawback_coins': {
    ...
    dapp: [
      {
        command: 'chik_spendClawbackCoins',
  ...
  'chik_wallet.nft_mint_bulk': {
    ...
    params: [
      ...
      {
        name: 'xck_coins',
        label: () => i18n._(/* i18n */ { id: 'XCK Coins' }),
        type: 'json',
        isOptional: true,
      },
      {
        name: 'xck_change_target',
        label: () => i18n._(/* i18n */ { id: 'XCK Change Target' }),
        type: 'string',
        isOptional: true,
      },
      {
  ...
  'chik_wallet.did_update_metadata': {
    ...
    dapp: [
      {
        command: 'chik_updateDIDMetadata',
        preserveNestedDataKeys: true,
  ...
  'chik_data_layer.remove_subscriptions': {
    ...
    dapp: [
      {
        command: 'chik_removeSubscriptions',
  ...
  'chik_data_layer.clear_pending_roots': {
    ...
    dapp: [
      {
        command: 'chik_clearPendingRoots',
  ...
  'chik_data_layer.make_offer': {
    ...
    dapp: [
      {
        command: 'chik_makeDataLayerOffer',
  ...
  'chik_data_layer.take_offer': {
    ...
    dapp: [
      {
        command: 'chik_takeDataLayerOffer',
  ...
  'chik_data_layer.cancel_offer': {
    ...
    dapp: [
      {
        command: 'chik_cancelDataLayerOffer',
  ...
  'chik_data_layer.verify_offer': {
    ...
    dapp: [
      {
        command: 'chik_verifyOffer',
        title: () => i18n._(/* i18n */ { id: 'Verify Offer' }),
      },
    ],
  },

  'chik_wallet.register_remote_coins': {
    ...
    dapp: [
      {
        command: 'chik_registerRemoteCoins',
  ...
  'chik_wallet.get_wallet_balances': {
    ...
    dapp: [
      {
        command: 'chik_getWalletBalances',
        title: () => i18n._(/* i18n */ { id: 'Get Wallet Balances' }),
        message: () =>
          i18n._(
            /* i18n */ {
  ...
  'chik_wallet.get_coin_records_by_names': {
    ...
    dapp: [
      {
        command: 'chik_getCoinRecordsByNames',
        title: () => i18n._(/* i18n */ { id: 'Get Coin Records by Name' }),
        message: () =>
          i18n._(/* i18n */ { id: "Requests the status of a list of coin records from the Wallet's coin store." }),
  ...
  'chik_wallet.get_spendable_coins': {
    ...
    dapp: [
      {
        command: 'chik_getSpendableCoins',
        title: () => i18n._(/* i18n */ { id: 'Get Spendable Coins' }),
        message: () => i18n._(/* i18n */ { id: 'Requests spendable coins for a specific wallet' }),
        requiresSync: true,
        defaults: { wallet_id: 1 },
  ...
  'chik_wallet.get_next_address': {
    ...
    dapp: [
      ...
      {
        command: 'chik_getCurrentAddress',
  ...
  'chik_wallet.get_full_node_peer_count': {
    ...
    dapp: [
      {
        command: 'chik_getFullNodePeerCount',
        title: () => i18n._(/* i18n */ { id: 'Get Full Node Peer Count' }),
        message: () =>
          i18n._(/* i18n */ { id: 'Requests the number of full node peers currently connected to the wallet' }),
  ...
  'chik_wallet.get_puzzle_and_solution': {
    ...
    dapp: [
      {
        command: 'chik_getPuzzleAndSolution',
        title: () => i18n._(/* i18n */ { id: 'Get puzzle and solution' }),
        message: () =>
  ...
  'chik_wallet.check_offer_validity': {
    ...
    dapp: [
      {
        command: 'chik_checkOfferValidity',
        title: () => i18n._(/* i18n */ { id: 'Check Offer Validity' }),
        message: () => i18n._(/* i18n */ { id: 'Requests the validity status of a specific offer' }),
        allowConfirmationBypass: true,
      },
  ...
  'chik_wallet.nft_get_wallets_with_dids': {
    ...
    dapp: [
      {
        command: 'chik_getNFTWalletsWithDIDs',
        title: () => i18n._(/* i18n */ { id: 'Get NFT Wallets with DIDs' }),
  ...
  'chik_wallet.did_get_current_coin_info': {
    ...
    dapp: [
      {
        command: 'chik_getDIDCurrentCoinInfo',
        title: () => i18n._(/* i18n */ { id: 'Get DID Current Coin Info' }),
        allowConfirmationBypass: true,
      },
    ],
  ...
  'chik_data_layer.get_sync_status': {
    ...
    dapp: [
      {
        command: 'chik_getDataLayerSyncStatus',
        title: () => i18n._(/* i18n */ { id: 'Get DataLayer Sync Status' }),
        allowConfirmationBypass: true,
      },
    ],
  ...
  'daemon.get_wallet_addresses': {
    ...
    dapp: [
      {
        command: 'chik_getWalletAddresses',
        title: () => i18n._(/* i18n */ { id: 'Get wallet addresses for one or more wallet keys' }),
