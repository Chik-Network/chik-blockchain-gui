...
const defaultMetadata = {
  ...
  url: 'https://www.chiknetwork.com',
  icons: ['https://www.chiknetwork.com/wp-content/uploads/2022/09/chik-logo.svg'],
};
...
function getSingleton(): WalletConnectSingleton {
  const globalStore = globalThis as typeof globalThis & {
    chikWalletConnectSingleton?: WalletConnectSingleton;
  };
  if (!globalStore.chikWalletConnectSingleton) {
    globalStore.chikWalletConnectSingleton = {};
  }
  return globalStore.chikWalletConnectSingleton;
}
