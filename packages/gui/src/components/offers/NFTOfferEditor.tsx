...
import { useCreateOfferForIdsMutation, useGetWalletBalanceQuery } from '@chik-network/api-react';
import {
  Amount,
  AmountProps,
  Back,
...
/*       An NFT offer consists of a single NFT being offered for XCK/CAT      */
/* ========================================================================== */
...
/* ========================================================================== */
/*                              NFT Offer Editor                              */
/*           Currently only supports a single NFT <--> XCK/CAT offer          */
/* ========================================================================== */
...
function buildOfferRequest(params: NFTBuildOfferRequestParams) {
  ...
  const baseMojoAmount: BigNumber =
    tokenWalletInfo.walletType === WalletType.CAT ? catToMojo(tokenAmount) : chikToMojo(tokenAmount);
  const mojoAmount = exchangeType === NFTOfferExchangeType.NFTForToken ? baseMojoAmount : baseMojoAmount.negated();
  const feeMojoAmount = chikToMojo(fee);
