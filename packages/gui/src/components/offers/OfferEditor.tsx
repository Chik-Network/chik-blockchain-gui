...
import { useCreateOfferForIdsMutation } from '@chik-network/api-react';
import { Back, Button, Card, ButtonLoading, Flex, Form, useShowError, chikToMojo, catToMojo } from '@chik-network/core';
...
function OfferEditor(props: OfferEditorProps) {
  ...
  async function onSubmit(formData: FormData) {
    ...
    const feeInMojos = chikToMojo(formData.fee ?? 0);
