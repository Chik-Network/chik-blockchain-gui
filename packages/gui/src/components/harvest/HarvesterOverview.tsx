import { useGetHarvestersQuery, useGetNewFarmingInfoQuery } from '@chik-network/api-react';
import { Flex, FormatBytes, FormatLargeNumber, CardSimple } from '@chik-network/core';
