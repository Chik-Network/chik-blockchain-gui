import { CardStep, ConfirmDialog, Link, Select, StateColor, useOpenDialog } from '@chik-network/core';
    ...
    >
      <Typography variant="subtitle1">
        <Trans>
          ...
          <Link target="_blank" href="https://github.com/Chik-Network/chik-blockchain/wiki/k-sizes">
            Learn more
          </Link>
        </Trans>
      </Typography>
