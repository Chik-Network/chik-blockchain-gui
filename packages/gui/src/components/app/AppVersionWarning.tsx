import { Button, Flex } from '@chik-network/core';
        ...
        <DialogContent>
          <Flex flexDirection="column" gap={1}>
            <Typography variant="body2" color="textSecondary">
              <Trans>
                The Chik application and its services are using different versions. Some functionality may not be behave
                properly as a result.
                <br />
                <br />
                Chik services version: {backV}
                <br />
                Chik application version: {guiV}
                <br />
                <br />
                It is recommended that you quit the Chik application and stop all Chik services.
              </Trans>
            </Typography>
          </Flex>
        </DialogContent>
