import { SelectKey, LayoutHero, LayoutDashboard, Mode, useMode } from '@chik-network/core';
import { WalletAdd, WalletImport, Wallets } from '@chik-network/wallets';
import React from 'react';
import { HashRouter, Routes, Route, Navigate } from 'react-router-dom';

import AddressBook from '../addressbook/AddressBook';
import Block from '../block/Block';
import ChikToolsPage from '../chiktools/ChikToolsPage';
        ...
        <Route path="/" element={<AppProviders outlet />}>
          ...
          {mode === Mode.WALLET ? (
            ...
            >
              ...
              <Route path="dashboard/chiktools/*" element={<ChikToolsPage />} />
            </Route>
          ) : (
