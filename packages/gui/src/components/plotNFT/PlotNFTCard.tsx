import { useDeleteUnconfirmedTransactionsMutation } from '@chik-network/api-react';
import {
  Button,
  Color,
  TooltipTypography,
...
import { Plot as PlotIcon } from '@chik-network/icons';
...
export default function PlotNFTCard(props: Props) {
  ...
  const rows = [
    ...
    isSelfPooling && {
      ...
      value: <UnitFormat value={mojoToChikLocaleString(balance)} state={State.SUCCESS} />,
    },
    {
      key: 'plotsCount',
