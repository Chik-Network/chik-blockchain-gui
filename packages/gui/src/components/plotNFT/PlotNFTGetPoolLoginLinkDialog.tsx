import type { PlotNFT, PlotNFTExternal } from '@chik-network/api';
import { useGetPoolLoginLinkQuery } from '@chik-network/api-react';
import { Button, CopyToClipboard, Flex, Link, Loading } from '@chik-network/core';
          ...
          {isLoading ? (
            ...
            <Flex flexDirection="column" gap={2}>
              ...
              <Typography variant="body2" color="textSecondary">
                ...
                <Link
                  target="_blank"
                  href="https://github.com/Chik-Network/pool-reference/blob/main/SPECIFICATION.md#get-login"
                  noWrap
                >
