...
import { Flex, getSemanticColors, Link, StateIndicator, State, Tooltip, useCurrencyCode } from '@chik-network/core';
      ...
      <Box>
        ...
        <p>
          ...
          <StyledTableForTooltip>
            ...
            <tr>
              <Link target="_blank" href="https://docs.chiknetwork.com/faq/#why-does-my-chik-farm-say-missing-signage-points">
