...
import { FormatBytes, FormatLargeNumber, mojoToChikLocaleString, useCurrencyCode, useLocale } from '@chik-network/core';
import {
...
function useFormattedXCKBalance() {
  ...
  const confirmed = mojoToChikLocaleString(walletBalance.confirmedWalletBalance ?? 0, locale);
  const spendable = mojoToChikLocaleString(walletBalance.spendableBalance ?? 0, locale);
...
export default function DashboardOverview() {
  const xckBalance = useFormattedXCKBalance();
