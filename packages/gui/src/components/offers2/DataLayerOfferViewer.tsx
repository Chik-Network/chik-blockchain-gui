import type { DataLayerOfferSummary, SingletonSummaryRecord } from '@chik-network/api';
import { Color, CopyToClipboard, Flex, Truncate, truncateValue } from '@chik-network/core';
