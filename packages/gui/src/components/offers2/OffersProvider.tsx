...
import { useGetOfferSummaryMutation, useCheckOfferValidityMutation } from '@chik-network/api-react';
import { isValidURL } from '@chik-network/core';
...
const log = debug('chik-gui:OfferProvider');
