...
import { Flex, Loading, catToMojo, mojoToCATLocaleString } from '@chik-network/core';
import { Tokens } from '@chik-network/icons';
...
export default function OfferBuilderTokensSection(props: OfferBuilderTokensSectionProps) {
  ...
  return (
    <OfferBuilderSection
      ...
      subtitle={<Trans>Chik Asset Tokens (CATs) are tokens built on top of XCK</Trans>}
