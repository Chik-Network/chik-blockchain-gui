...
window.addEventListener('unhandledrejection', (event) => {
  ...
  if (!isWalletConnectOrigin) {
    console.warn('[chik-gui] "No matching key" rejection from non-WalletConnect origin; not suppressing:', reason);
    return;
  }

  console.info('[chik-gui] Suppressing WalletConnect stale-key rejection:', message);
