...
import { bladebitRamDefaults, bladebitDiskDefaults, madmaxDefaults, chikposDefaults } from '../constants/Plotters';
...
export default function defaultsForPlotter(plotterName: PlotterName): PlotterDefaults {
  switch (plotterName) {
    ...
    case PlotterName.CHIKPOS: // fallthrough
    default:
      return chikposDefaults;
  }
}
