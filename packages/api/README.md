...
This library provides support for TypeScript/JavaScript [Chik](https://www.chiknetwork.com) apps to access the [Chik Blockchain RPC](https://docs.chiknetwork.com/rpc/), by making it easier to perform the following actions:
