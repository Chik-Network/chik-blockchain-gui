...
import { useSetCATNameMutation, useGetCatListQuery } from '@chik-network/api-react';
import { Flex, Loading, MenuItem, useOpenDialog } from '@chik-network/core';
import { Offers as OffersIcon } from '@chik-network/icons';
