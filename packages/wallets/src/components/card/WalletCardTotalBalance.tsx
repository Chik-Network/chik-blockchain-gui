import { useGetWalletBalanceQuery, useGetCurrentDerivationIndexQuery } from '@chik-network/api-react';
import { CardSimple, Flex, TooltipIcon } from '@chik-network/core';
            ...
            <Flex alignItems="center" gap={1}>
              ...
              <TooltipIcon>
                <Trans>
                  ...
                  number is generally higher if you have a lot of transactions or canceled offers for XCK, CATs, or
