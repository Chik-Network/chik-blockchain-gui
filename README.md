...
- Always have **chik-blockchain-gui opened as a root folder in the Vscode** and not chik-blockchain, or chik-blockchain-gui/packages/... Failing to do so will result in incorrect auto linting and auto formatting which would not go trough the CI quality checks.
...
2. In the chik-blockchain directory, run this to setup the ENV variables. Use these instead the ones mentioned in the above guide.
